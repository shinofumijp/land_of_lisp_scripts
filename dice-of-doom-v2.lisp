...
(defun add-passing-move (board player spare-dice first-move moves)
  (if first-move
    moves
    (lazy-cons (list nil
                     (game-tree (add-new-dice-optimized board player
                                              (1- spare-dice))
...
(defun play-vs-computer-ab (tree)
  (print-info tree)
  (cond ((lazy-null (caddr tree)) (announce-winner (cadr tree)))
        ((zerop (car tree)) (play-vs-computer-ab (handle-human tree)))
        (t (play-vs-computer (handle-computer-ab tree)))))
